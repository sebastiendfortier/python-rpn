...
def fstprm(key):
    ...
    return {
        ...
        'ip2'   : cip2.value,
        'ip3'   : cip3.value,
        'typvar': _C_CHAR2WCHAR(ctypvar.value).strip(),
        'nomvar': _C_CHAR2WCHAR(cnomvar.value).strip(),
        'etiket': _C_CHAR2WCHAR(cetiket.value).strip(),
        'grtyp' : _C_CHAR2WCHAR(cgrtyp.value).strip(),
        'ig1'   : cig1.value,
        'ig2'   : cig2.value,
        'ig3'   : cig3.value,
        'ig4'   : cig4.value,
