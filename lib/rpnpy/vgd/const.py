...
VGD_OPR_KEYS = {
    ...
    'put_int'       : ["DATE", "IG_1", "IG_2", "IG_3", "IG_4", "IP_1", "IP_2",
                       "IP_3", "DIPM", "DIPT"],
    'get_float'     : ["RC_1", "RC_2", "RC_3", "RC_4", "DHM", "DHT", "DHW"],
    'get_int_1d'    : ["VIP1", "VIPM", "VIPT", "VIPW"],
    'get_float_1d'  : ["VCDM", "VIPM", "VCDT", "VIPT", "VCDW", "VIWT"],
    'put_double'    : [],
    'get_double'    : ["PTOP", "PREF", "RC_1", "RC_2"],
    'get_double_1d' : ["CA_M", "COFA", "CB_M", "COFB", "CA_T", "CB_T", "CA_W", "CB_W", "CC_M" , "CC_T", "CC_W"],
    'get_double_3d' : ["VTBL"],
